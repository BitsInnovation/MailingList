...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.from_email'
        db.add_column(u'list_group', 'from_email',
                      self.gf('django.db.models.fields.EmailField')(default='me@chrisbartos.com', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.from_email'
        db.delete_column(u'list_group', 'from_email')
